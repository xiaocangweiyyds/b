...
public class MailTest {  
    ...
    //发送的邮箱 内部代码只适用qq邮箱  
    private static final String USER = "2806624708@qq.com";  
    //授权密码 通过QQ邮箱设置->账户->POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务->开启POP3/SMTP服务获取  
    private static final String PWD = "ypjqnnrilpjedggb";  
...
//        mail.setFileList(new String[] {"C:\\Users\\Administrator\\Desktop\\a.jpg"});  
    ...
    public void sendMail(String name,String email) {
		...
		String content = "<a href='https://192.168.1.251:8080/mybatisspringspringmvc/active?name="+name+"'>点击激活</a>";
		mail.setContent(content);
